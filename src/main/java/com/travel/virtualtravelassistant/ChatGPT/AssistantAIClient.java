...
import com.travel.virtualtravelassistant.ChatGPT.dto.*;
...
import static com.travel.virtualtravelassistant.ChatGPT.model.GPTModel.GPT4_1106_PREVIEW;
...
public class AssistantAIClient {
    ...
    public AssistantAIClient(Properties properties) {
        this.apiKey = System.getenv("OpenAI API");
